...
gui:
	        gcc -Wall -Wextra -Ofast $(SDL2_CFLAGS) $(SDL2_LIBS) -o nanopond nanopond.c -lpthread
		gcc -D USE_PTHREADS_COUNT=4 -Wall -Wextra -Ofast $(SDL2_CFLAGS) $(SDL2_LIBS) -o nanopond-parallel nanopond.c -lpthread
clean:
